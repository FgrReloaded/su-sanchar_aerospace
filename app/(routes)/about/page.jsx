                ...
                <div className="bg-white py-40 px-8 sm:px-20 flex flex-col gap-6 sm:gap-12">
                    ...
                    <div className="flex items-center mt-6 md:flex-row flex-col md:gap-0 gap-8">
                        <div className="w-full md:w-1/2 h-[480px] ">
                            <Image width={1000} height={1000} src="/img/about-1.jpg" alt="card-1" className="w-full h-full object-cover rounded-2xl" />
                        </div>
                    ...
                    <div className="flex items-center mt-6 md:flex-row-reverse flex-col-reverse md:gap-0 gap-8">
                        <div className="w-full md:w-1/2 h-[480px] ">
                            <Image width={1000} height={1000} src="/img/about-1.1.jpg" alt="card-2" className="w-full h-full object-cover rounded-2xl" />
                        </div>
                        <p style={questrial.style} className="w-full md:w-1/2 px-8 md:px-20 text-justify leading-8 text-sm">At Su-Sanchar, we specialize in drone manufacturing with a mission to revolutionize communication with remote areas. We believe that drones can solve communication problems in areas that were previously impossible to reach. That&apos;s why we have dedicated ourselves to creating the best communication drones available on the market today. We offer a range of services aimed at making the world a better place through the use of drone technology.</p>
                    </div>
                </div>
            ...
            <section>
                <div className="bg-white py-10 px-8 sm:px-20 flex flex-col gap-6 sm:gap-12">
                    ...
                    <div className="flex gap-6 justify-center w-full flex-wrap">
                        <div className="bg-black  flex flex-col w-full md:w-[25%] rounded-2xl overflow-hidden">
                            <div className="px-6 pt-12 mb-5 text-white md:h-[250px]">
                                <p style={space_grotesk.style} className="text-center">
                                    <span className="font-extrabold text-2xl">ADARSH SINGH</span>
                                    <br />
                                    (Mentor)
                                </p>
                                <p style={questrial.style} className="flex flex-col text-justify mt-6">
                                    <span>BE in  ECE Graduated in 2021, CEO of Hoverin aerospace Pvt Ltd, Skills in Embedded, IoT, Business Analyst, Coordinated E-Cell in College.</span>
                                </p>
                            </div>
                            <div className="w-full md:h-[250px]">
                                <Image width={1000} height={1000} src="/img/team/adarsh-singh.png" alt="team-1" className="w-full h-full object-contain grayscale" />
                            </div>
                        </div>
                        <div className="bg-white flex flex-col w-full  md:w-[25%] rounded-2xl overflow-hidden shadow-xl">
                            <div className="px-6 pt-12 mb-5 text-black md:h-[250px]">
                                <p style={space_grotesk.style} className="text-center">
                                ...
                                <p style={questrial.style} className="flex flex-col text-justify mt-6">
                                    <span>BE in  ECE Graduated in 2021, CEO of Hoverin aerospace Pvt Ltd, Skills in Robotics, Embedded, IoT & ML, Leaded Robotics Club in College.</span>
                                </p>
                            </div>
                            <div className="w-full md:h-[250px]">
                                <Image width={1000} height={1000} src="/img/team/pradeep-kumar.png" alt="team-1" className="w-full h-full object-contain" />
                            </div>
                        </div>
                        <div className="bg-black flex flex-col w-full md:w-[25%] rounded-2xl overflow-hidden">
                            <div className="px-6 pt-12 mb-5 text-white md:h-[250px]">
                                ...
                                <p style={questrial.style} className="flex flex-col text-justify mt-6">
                                    <span>BE in  ME Graduated in 2023, CMO of Hoverin aerospace Pvt Ltd, Skills in Graphic Design, Digital marketing, Volunteer and TedX Tajnagri in College.</span>
                                </p>
                            </div>
                            <div className="w-full md:h-[250px]">
                                <Image width={1000} height={1000} src="/img/team/parth-pradhumn.png" alt="team-1" className="w-full h-full object-contain" />
                            </div>
                        </div>
                        <div className="bg-white flex flex-col w-full  md:w-[25%] rounded-2xl overflow-hidden shadow-xl">
                            <div className="px-6 pt-12 mb-5 text-black md:h-[250px]">
                                ...
                                <p style={questrial.style} className="flex flex-col text-justify mt-6">
                                    <span>BE in  ME Graduated in 2021, CTO of Hoverin aerospace Pvt Ltd, Skills in Manufacturing, Production, CAD design.</span>
                                </p>
                            </div>
                            <div className="w-full md:h-[250px]">
                                <Image width={1000} height={1000} src="/img/team/naved-aktar.png" alt="team-1" className="w-full h-full object-contain" />
                            </div>
                        </div>
                        <div className="bg-black flex flex-col w-full justify-center  md:w-[25%] rounded-2xl overflow-hidden shadow-xl">
                            <div className="px-6 pt-12 mb-5 text-white md:h-[250px]">
                                <p style={space_grotesk.style} className="text-center">
                                ...
                                <p style={questrial.style} className="flex flex-col text-center mt-6">
                                    <span>MBA in  marketing Post Graduated in 2009, Skills in Strategic Business Advisor.</span>
                                </p>
                            </div>
                        </div>
